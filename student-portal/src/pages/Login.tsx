      ...
      <div className="w-full md:w-1/2 flex items-center justify-center px-4 relative z-10">
        <div className="max-w-sm w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Student Portal</p>
          </div>
          <form
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600 dark:placeholder-gray-500"
                />
                <button
                  type="button"
