...
export function PageHeader({
  ...
  return (
    <div
      className="mb-6 -mx-3 -mt-3 px-3 py-2.5 sm:-mx-4 sm:-mt-4 sm:px-4 md:-mx-6 md:-mt-6 md:px-6 md:py-3 relative overflow-hidden"
    ...
    >
      ...
      {/* Content — fixed banner height for consistency across all pages */}
      <div className="relative z-10 flex flex-col justify-center min-h-[56px]">
        {backButton && (
          <button
