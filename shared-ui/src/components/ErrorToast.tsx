...
export function ErrorToast({ message, onDismiss, duration = 5000 }: ErrorToastProps) {
  ...
  return (
    ...
    >
      <div className="bg-red-50 dark:bg-red-900/40 border border-red-200 dark:border-red-800 rounded-lg p-4 shadow-lg flex items-start gap-3">
        ...
        <button onClick={onDismiss} className="text-red-400 hover:text-red-600 dark:text-red-500 dark:hover:text-red-300">
